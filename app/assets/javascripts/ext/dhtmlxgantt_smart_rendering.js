...
gantt.config.smart_rendering = !0, gantt._smart_render = {
        getViewPort: function() {
            var t = this.getScrollSizes(),
                e = gantt._restore_scroll_state();
        ...
        getScrollSizes: function() {
            ...
            return t.x = t.x || 0, t.y = t.y || gantt._order.length * gantt.config.row_height, t
        },
        ...
        getLinkPosition: function(t) {
            var e = gantt.getLink(t),
                n = gantt.getTaskTop(e.source),
                a = gantt.getTaskTop(e.target);
            return {
                y: Math.min(n, a),
        ...
        getRange: function(t) {
            ...
            var e = this.getViewPort(),
                n = Math.floor(Math.max(0, e.y) / gantt.config.row_height) - t,
                a = Math.ceil(Math.max(0, e.y_end) / gantt.config.row_height) + t,
                i = gantt._order.slice(n, a);
            return i
        },
        ...
        updateRender: function() {
            ...
            this._recalculateLinkedProjects(t), this._redrawItems(gantt._get_task_renderers(), this._getVisibleTasks()), this._redrawItems(gantt._get_link_renderers(), t), gantt.callEvent("onSmartRender", [])
        },
        cached: {},
        _takeFromCache: function(t, e, n) {
            this.cached[n] || (this.cached[n] = null);
            var a = this.cached[n];
            return void 0 !== t ? (a || (a = this.cached[n] = {}), void 0 === a[t] && (a[t] = e(t)), a[t]) : (a || (a = e()), a)
        },
        initCache: function() {
            for (var t = ["getLinkPosition", "getTaskPosition", "isTaskDisplayed", "isLinkDisplayed", "getViewPort", "getScrollSizes"], e = 0; e < t.length; e++) {
                var n = t[e],
                    a = gantt.bind(this[n], this);
                this[n] = function(t, e) {
                    return function(n) {
        ...
        invalidateCache: function() {
            function t() {
                s.cached.getViewPort = null, s.cached.getScrollSizes = null, s.cached.isTaskDisplayed = null, s.cached.isLinkDisplayed = null
            }

            function e() {
                s.cached.isTaskDisplayed = null,
                    s.cached.isLinkDisplayed = null, s.cached.getLinkPosition = null, s.cached.getTaskPosition = null
            }
            ...
            gantt.attachEvent("onClear", function() {
                    ...
                    n()
                }), gantt.attachEvent("onAfterLinkUpdate", i),
                gantt.attachEvent("onAfterTaskAdd", n), gantt.attachEvent("onAfterTaskDelete", n), gantt.attachEvent("onAfterTaskUpdate", a), gantt.attachEvent("onGanttScroll", t), gantt.attachEvent("onDataRender", n), this.invalidateCache = function() {}
        }
